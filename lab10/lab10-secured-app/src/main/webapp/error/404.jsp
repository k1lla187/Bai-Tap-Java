...
<head>
    ...
    <style>
        ...
        .code { font-size: 80px; font-weight: 800; color: #667eea; line-height: 1; }
...
<body>
    <div class="card">
        ...
        <p>Trang ban dang tim khong ton tai hoac da bi chuyen di. Vui long kiem tra lai dia chi URL.</p>
