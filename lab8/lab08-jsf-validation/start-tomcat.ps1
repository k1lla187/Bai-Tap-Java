# Script to download and run Tomcat 10.1.17 for Lab 8
...
if (Test-Path $warFile) {
    ...
    Copy-Item -Path $warFile -Destination "$webappsDir\lab08-jsf-validation.war" -Force
    Write-Host "WAR deployed: $webappsDir\lab08-jsf-validation.war" -ForegroundColor Green
} else {
